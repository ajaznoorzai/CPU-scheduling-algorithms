...
public abstract class  Process implements Comparable<Process> {
  ...
  //Turnaround time = terminatedTime - createdTime
  //
  //Waiting time = turnaroundTime - cpuTime
  //
  //Response time = startedTime - createdTime
...
//    return getTurnaroundTime() - cpuTime - blockedTime;      ///
    return (terminatedTime - createdTime) - cpuTime - blockedTime;      /////TODO
 //return (terminatedTime-createdTime)- cpuTime;
//    int waitingTime = blockedTime - createdTime;
//
//    if (startedTime > 0) {
//      waitingTime -= (terminatedTime - startedTime);
//    }
//
//    if (waitingTime < 0) {
//      waitingTime = 0;
